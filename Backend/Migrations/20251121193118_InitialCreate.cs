...
namespace Backend.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Vehicles",
                columns: new[] { "Id", "Brand", "Category", "DailyRate", "FuelType", "ImageUrl", "Mileage", "Model", "RegistrationNumber", "SeatingCapacity", "Status", "Year" },
                values: new object[,]
                {
                    { 1, "Toyota", 1, 35.00m, "Gasoline", null, 15000, "Corolla", "ABC123", 5, 0, 2023 },
                    { 2, "BMW", 3, 85.00m, "Diesel", null, 5000, "X5", "XYZ789", 7, 0, 2024 },
                    { 3, "Mercedes-Benz", 4, 120.00m, "Gasoline", null, 3000, "C-Class", "LUX456", 5, 0, 2024 },
                    { 4, "Honda", 0, 28.00m, "Gasoline", null, 20000, "Civic", "ECO789", 5, 0, 2023 }
                });
